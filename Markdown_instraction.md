...
Перед командой __git push__ нужно "познакомить" локальный git с GitHub, следуя инструкции в git. 

* Чтобы клонировать внешний репозиторий на локальный ПК, используется команда __git clone__ <url-адресс репозитория>
* Чтобы направить изменения из локального репозитория на удаленный, используется команда __git push__ 
* Чтобы "вытянуть" актуальную версию из удаленного репозитория на GitHub и перетянуть ее в локальный репозиторий, используется команда __git pull__
